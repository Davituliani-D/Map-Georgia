...
import classes from "../SamkhreJavakhetiMap/SamkhreJavakhetiMap.module.css";

const SamkhreJavakhetiMap = () => {
  return (
    <svg>
      <path
          className={classes.partSamkhreJavakheti}
...
export default SamkhreJavakhetiMap;
