...
const KakhetiLeftbarItem = (props) => {
  return (
    ...
    <AccordionSummary
      ...
      id="panel1a-header"
    >
      <Typography style={{fontWeight: 700}}>{props.description}</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography>
...
const KakhetiLeftbar = (props) => {
  return (
    <div className={style.leftbar}>
      ...
      <KakhetiLeftbarItem description="ძირითადი ინფორმაცია:" />
        <Accordion
          style={{
